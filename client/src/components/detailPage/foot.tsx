...
// XSS saldırılarından korunmak için backendden gelen html kodunu doğrudan dangerouslySetInnerHTML ile enjekte etmeden önce DOMPurify kütüphanesiyle olası zararlı kodları temizliyoruz
