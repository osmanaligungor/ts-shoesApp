  ...
  return (
    <div className="relative">
      <div className="absolute text-white top-1/2 transform -translate-y-1/2 ps-4 md:ps-6 lg:ps-8 xl:ps-10">
        ...
        <h1 className="text-[22px] sm:text-[27px] md:text-[32px] lg:text-[48px] xl:text-[68px] font-semibold">
          %30 indirim
        </h1>

        <p className="font-open text-gray text-[14px] sm:text-[18px] lg:text-[20px] xl:text-[24px] max-w-[80%]">
