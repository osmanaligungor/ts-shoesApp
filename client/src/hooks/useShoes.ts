...
export function useShoes() {
  ...
  const create = useMutation({
    ...
    onSuccess: () => {
      // oluşturma işlemi başarılı olursa ekrandaki verilerin güncellenmesi için shoes keyine sahip ayakkabı verilerini getiren query fonksiyonunu tetikliyoruz
  ...
  return { shoe, shoes, create, edit, remove };
}
